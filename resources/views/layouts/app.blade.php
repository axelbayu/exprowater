    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-brand {
            ...
            color: #fff; letter-spacing: .6px; text-decoration: none;
        }
        .nav-brand .drop {
        ...
        .nav-brand .drop span {
            width: 9px; height: 12px; background: var(--navy);
            border-radius: 50% 50% 50% 50% / 60% 60% 40% 40%; display: block;
        }
        .nav-links { display: flex; align-items: center; gap: .15rem; }
        .nav-links a {
            color: #90caf9; text-decoration: none; font-size: 13px;
            padding: 6px 13px; border-radius: 6px;
            transition: background .15s, color .15s;
        }
        .nav-links a:hover { background: rgba(255,255,255,.08); color: #fff; }
        .nav-links a.active { background: rgba(255,255,255,.13); color: #fff; font-weight: 500; }

        .nav-user { display: flex; align-items: center; gap: 8px; font-size: 12px; color: #fff; }
        .avatar {
        ...
        /* ── FLASH ── */
        .flash { padding: 10px 16px; border-radius: 8px; font-size: 13px; margin-bottom: 1.25rem; border-left: 3px solid; }
        ...
        th {
            ...
            letter-spacing: .6px; border-bottom: .5px solid var(--border); white-space: nowrap;
        }
        td { padding: 10px 14px; border-bottom: .5px solid #eef3f8; color: var(--text); }
        ...
        .form-control {
            background: #f8fafc; border: .5px solid var(--border);
        ...
        .pagination-wrap {
            ...
            justify-content: space-between; border-top: .5px solid var(--border);
        ...
        /* ── FILTERS ── */
        .filters { display: flex; gap: 8px; padding: 1rem 1.25rem; border-bottom: .5px solid var(--border); background: #f9fbfd; }
        .filter-input {
            flex: 1; background: var(--surface); border: .5px solid var(--border);
        ...
        .filter-select {
            ...
            color: var(--muted); font-family: 'Plus Jakarta Sans', sans-serif; outline: none;
        }

        /* ── FOOTER ── */
        footer {
            background: var(--surface); border-top: .5px solid var(--border);
            padding: .85rem 1.75rem; display: flex;
        ...
        .section-divider {
            ...
            padding-bottom: .5rem; border-bottom: .5px solid var(--border); margin-bottom: 1rem;
        }
    </style>
    @stack('styles')
</head>
