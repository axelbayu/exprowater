...
<body>
    ...
    <div class="panel-left">
        ...
        <div class="panel-hero">
            ...
            <p>
                Platform manajemen pesanan dan distribusi produk pengolahan air
                Exprowater — efisien, modern, dan terorganisir.
            </p>
            ...
            <div class="panel-stats">
                ...
                <div>
                    ...
                    <div class="stat-lbl">Kepuasan Klien</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel-right">
        <div class="login-box">
            ...
            @if(session('success'))
                <div style="background:#e0f5f0;border:1px solid #0d6e4a;border-radius:8px;padding:10px 14px;font-size:12px;color:#0d6e4a;margin-bottom:1.25rem;">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <div class="login-footer">
                &copy; {{ date('Y') }} Exprowater — Sistem Manajemen Order
            </div>
